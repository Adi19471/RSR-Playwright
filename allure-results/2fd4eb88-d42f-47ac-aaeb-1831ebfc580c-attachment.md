...
- Name: admin\admin-master-screens.spec.ts >> Wagons master screen loads with search, New button and grid
...
Locator: getByRole('heading', { name: 'WagonType', exact: true })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'WagonType', exact: true })
